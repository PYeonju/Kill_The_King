...
public:
	...
	std::vector<CObjectBase*> WallObjectPool;	// 석궁병 오브젝트 풀

	std::vector<CObjectBase*> Stage00Pool;	// 석궁병 오브젝트 풀
	std::vector<CObjectBase*> Stage01Pool;	// 석궁병 오브젝트 풀
	std::vector<CObjectBase*> Stage02Pool;	// 석궁병 오브젝트 풀
	std::vector<CObjectBase*> Stage03Pool;	// 석궁병 오브젝트 풀
